...
Public Type t_Hechizo
    ...
    Cooldown                    As Integer
    CdEffectId                  As Integer 'CoolDown Effect ID
    ScreenColor                 As Long
    TimeEfect                   As Long
    'Hechizo de teleport
...
Public Type t_UserFlags
    ...
    Incinerado                  As Byte
    Muerto                      As Byte    '¿Estámuerto?
    Escondido                   As Byte    '¿Estáescondido?
    Comerciando                 As Boolean    '¿Estácomerciando?
    UserLogged                  As Boolean    '¿Estáonline?
